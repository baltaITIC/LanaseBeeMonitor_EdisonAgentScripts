...
while True:
	...
	#print Degrees
	#print("Temperature is now "+tempC+" °C" +tempF+" °F")
	...
	print ("")
        ...
        client = mqtt.Client()
        client.connect("10.99.15.71",1883,60)
       
	client.publish("/id_site_1/light", ""+str(light))
        client.publish("/id_site_1/loudness", ""+str(loudness))
        client.publish("/id_site_1/vibration", ""+str(vibration))
        client.publish("/id_site_1/accelerometer", ""+(string))
